...
2. Write a program to assign the number 34.5678 to a variable named “number” then
...
19. Write a program to store marks of 5 students for 5 subjects given through the keyboard.
